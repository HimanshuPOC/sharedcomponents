 ...
 import { DemoSharedComponent } from './hello-world.component';

describe('When myprofilecomponent is invoked', () => {
    let helloWorldComponent: DemoSharedComponent;
    ...
    beforeEach(() => {
        ...
        helloWorldComponent = new DemoSharedComponent(userProfileService);
